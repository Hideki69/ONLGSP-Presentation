...
if(count($errors) == 0)
{
	...
	$req = "INSERT INTO users(nom, prenom, pseudo, adresse, cp, ville, pays, email, passwd,
					actif)
					VALUES(:nom, :prenom, :pseudo, :adresse, :cp, :ville, :pays, :email,
					:passwd, :actif)";
	//préparation
