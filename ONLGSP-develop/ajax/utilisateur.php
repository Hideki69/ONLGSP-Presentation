...
<div class="col-sm-6 col-sm-offset-3 positionTab">
    ...
    <table class="table  table-striped">
        <thead>
            <tr>
                <th class="mediaUser">ID Users</th>
                <th class="mediaUser">Pseudo</th>
                <th>Nom</th>
                <th>Prénom</th>
                <th>Email</th>
            </tr>
        ...
        <tbody>
            ...
            <tr>
                <td class="mediaUser"><?= $données['idUsers'];?></td>
                <td class="mediaUser"><input type="text" value="<?=$données['pseudoUsers'];?>" class="form-control" onkeyup="javascript:document.getElementById('resultPseudo_<?= $données['idUsers'];?>').value=this.value"></td>
